...
function record_time() {
    ...
    let date = new Date()
    if (date.getHours() == 14 && date.getMinutes() == 34 & date.getSeconds() == 15) {
...
function check_out() {
    ...
    let stop = {"study_time":(study_time), "studying": false,"yesterday_time":localStorage.getItem("yesterday_study_time")}
    $.ajax({
        type: "POST",
        url: "/ytime",
        contentType: 'application/json',
